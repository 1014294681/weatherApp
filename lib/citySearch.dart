                ...
                Container(
                  ...
                  child: SafeArea(
                    ...
                    decoration: InputDecoration(
                        ...
                        labelText: "请输入",
                        labelStyle:
                            TextStyle(color: Colors.blueGrey.shade700, fontSize: 16)),
                    onChanged: (v) async {
                      GeoPoiLocationResp? locationResp = await FlutterQweather
                          .instance
  ...
  Widget _buildItem(String adm1, String adm2, String name, String id) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text(
          "$adm1 $adm2 $name",
          style: TextStyle(color: Colors.blueGrey.shade700, fontSize: 20),
        ),
      ),
    );
  }
